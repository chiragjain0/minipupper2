...
if __name__ == "__main__":
    ...
    pygame.time.wait(500)
    disp.show_image('moonphases/moon31.png')
    pygame.time.wait(500)
    disp.show_image('moonphases/moon32.png')
    pygame.time.wait(500)  
    disp.show_image('moonphases/moon33.png')
    pygame.time.wait(500)
    disp.show_image('moonphases/moon34.png')
    pygame.time.wait(500)  
    disp.show_image('moonphases/moon35.png')
    pygame.time.wait(500)
    disp.show_image('moonphases/moon41.png')
    pygame.time.wait(500)
    disp.show_image('moonphases/moon42.png')
    pygame.time.wait(500)  
    disp.show_image('moonphases/moon43.png')
    pygame.time.wait(500)
    disp.show_image('moonphases/moon44.png')
    pygame.time.wait(500)  
    disp.show_image('moonphases/moon45.png')
    pygame.time.wait(500)
    disp.show_image('moonphases/moon51.png')
    pygame.time.wait(500)
    disp.show_image('moonphases/moon52.png')
    pygame.time.wait(500)  
    disp.show_image('moonphases/moon53.png')
    pygame.time.wait(500)
    disp.show_image('moonphases/moon54.png')
    pygame.time.wait(500)  
    disp.show_image('moonphases/moon55.png')
    pygame.time.wait(500)
    disp.show_image('moonphases/moon11.png')
    pygame.time.wait(500)
    disp.show_image('moonphases/moon12.png')
